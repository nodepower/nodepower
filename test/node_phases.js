...
contract('NodePhases', function (accounts) {
    let token;
    ...
    it("create contract & check isSucceed, isFinished, bounty, allocation", async function () {
        ...
        await Utils.checkEtherBalance(allocationAddress3, allocationAddress3Balance)
        ...
        await Utils.balanceShouldEqualTo(token, bountyAddress, new BigNumber("20000000").valueOf())
    ...
    it("create contract & check refund", async function () {
        ...
        let account1Balance = Utils.getEtherBalance(accounts[1]);
